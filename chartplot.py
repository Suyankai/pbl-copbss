...
snr_fastica = pd.read_csv("snr_fastica_stat.csv", header=None).values
time_fastica = pd.read_csv("time_fastica_stat.csv", header=None).values
snr_cdica = pd.read_csv("snr_cdica_stat.csv", header=None).values
time_cdica = pd.read_csv("time_cdica_stat.csv", header=None).values
snr_ufica = pd.read_csv("snr_ufica_stat.csv", header=None).values
time_ufica = pd.read_csv("time_ufica_stat.csv", header=None).values
...
with plt.style.context(['science', 'ieee']):
    ...
    ax_cp.legend([line1], ["$R_t$"], loc='upper right')
